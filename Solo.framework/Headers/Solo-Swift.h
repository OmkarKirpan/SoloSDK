...
SWIFT_MODULE_NAMESPACE_PUSH("Solo")
...
- (NSArray<id <MTLTexture>> * _Nonnull)runTextureFaceHairHeadFullBodyMasksSegmentationWithTexture:(id <MTLTexture> _Nullable)texture input:(NSString * _Nonnull)input output:(NSString * _Nonnull)output SWIFT_WARN_UNUSED_RESULT;
- (NSArray<id <MTLTexture>> * _Nonnull)runTextureFaceHairBodyMasksSegmentationWithTexture:(id <MTLTexture> _Nullable)texture input:(NSString * _Nonnull)input output:(NSString * _Nonnull)output SWIFT_WARN_UNUSED_RESULT;
- (NSArray<id <MTLTexture>> * _Nonnull)runTextureHeadBodyMasksSegmentationWithTexture:(id <MTLTexture> _Nullable)texture input:(NSString * _Nonnull)input output:(NSString * _Nonnull)output SWIFT_WARN_UNUSED_RESULT;
